...
const SingUp=()=>{
    return <div className="w-1/2 px-20 flex flex-col justify-center gap-3">
        ...
        <TextInput withAsterisk leftSection={<IconAt style={{ width: rem(16), height: rem(16) }} />} label="Your email" placeholder="Your email"/>
        ...
        <Checkbox autoContrast label={<>I accept{' '}<Anchor>terms and conditions</Anchor></>} color="teal" />
        <Button autoContrast radius={8} variant="filled" color="teal">SignUp</Button>
